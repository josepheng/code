 ...
 * 
 */
@WebServiceClient(name = "GreetingImplService", targetNamespace = "http://webservice.example.josepheng.org/", wsdlLocation = "http://localhost:9999/ws/greeting?wsdl")
    ...
    extends Service
{
    ...
    private final static QName GREETINGIMPLSERVICE_QNAME = new QName("http://webservice.example.josepheng.org/", "GreetingImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/ws/greeting?wsdl");
    ...
    public Greeting getGreetingImplPort() {
        return super.getPort(new QName("http://webservice.example.josepheng.org/", "GreetingImplPort"), Greeting.class);
    }
    ...
    public Greeting getGreetingImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.example.josepheng.org/", "GreetingImplPort"), Greeting.class, features);
    }
